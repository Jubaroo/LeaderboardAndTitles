...
import org.jubaroo.mods.leaderboardtitles.util.BmlForm;
    ...
    public void answer(Properties answer) {
        ...
        if (skill) {
            ...
            if(answer.containsKey("optin") && answer.get("optin") == "true"){
                Initiator.debug("Player "+name+" has opted into Leaderboard system.");
                ...
                Initiator.debug("Player "+name+" has opted out of the Leaderboard system.");
