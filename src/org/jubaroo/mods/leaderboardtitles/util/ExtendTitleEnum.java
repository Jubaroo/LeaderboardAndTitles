...
public class ExtendTitleEnum {
     ...
     * @throws BadBytecode forwarded, Javassist stuff.
     */
    private void resizeEnumVALUES() throws BadBytecode, NotFoundException {
     ...
     */
    public synchronized void ExtendEnumEntries() throws BadBytecode, NotFoundException, CannotCompileException {
        createFieldsInEnum();
        CtClass ctClassEnum = HookManager.getInstance().getClassPool().get(this.className);
